...
public class DataConfigTest {
  private static final Logger log = Logger.getLogger(DataConfigTest.class);
  ...
  public StreamingForexPrices prices() {
    ...
    try {
      ...
      Map<String, Price> pricesLookup = new HashMap<String, Price>();
      prices = new StreamingForexPricesImplStub(streamDomain, accessToken, accountId, pairs, 
          unmarshaller, pricesLookup);
